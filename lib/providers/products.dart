...
class Products with ChangeNotifier {
  ...
  Future<void> fetchAndSetProducts([bool fliterByUser = false]) async {
    ...
    var url = Uri.https('shop-app-62b32-default-rtdb.firebaseio.com',
    ...
    try {
      ...
      url = Uri.https('shop-app-62b32-default-rtdb.firebaseio.com',
  ...
  Future<void> addProduct(Product product) async {
    final url = Uri.https('shop-app-62b32-default-rtdb.firebaseio.com',
